...
​
        ...
        public static String getTitleByID(int id) {
                for ( int k = 1; k< theBooks.size(); k++){
                        if (theBooks.get(k).getId() == id){
                             return theBooks.get(k).getTitle();
                        }
                }
...
​
        ...
        public static Book findBookByPartialTitle(String title) {
                for (int k = 1; k < theBooks.size(); k++) {
                        if (theBooks.get(k).getTitle().contains(title)) {
                                return theBooks.get(k);
...
​
        ...
        public static List<Book> getAllBooksForAuthor(String author) {
                ...
                for ( int k = 0; k< theBooks.size(); k++){
                        if ( theBooks.get(k).getAuthor()== author ){
                                authors.add(theBooks.get(k));
                        }
                }
                return authors;
        }
