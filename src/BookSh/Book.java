...
public class Book {
    ...
    public static boolean isTitleWord(String word) {
        String[] prepositions = { "a" , "an", "the", "and", "but", "for", "nor", "or", "so", "yet", "at", "by", "in", "into", "near", "of", "on", "to", "than", "via"};
        for(String name: prepositions ){
    ...
    public void setTitle(String title) {
        ...
        if (arrOfStr.length == 1) {
            ...
            for (int i = 1; i < arrOfStr.length; i++) {
                ...
                if (!isTitleWord(arrOfStr[i])) {
                    capitalize(arrOfStr[i]);
        ...
        for (int e = 0; e < title.length(); e++) {
                while (title.charAt(e) != ' ' && e < title.length() - 1) {
                    e++;
                    count++;
                }
    ...
    public String toString() {
        return this.author + "" + this.title + ""+ this.id+ ""+ this.pages+"";
